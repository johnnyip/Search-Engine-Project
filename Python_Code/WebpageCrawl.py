...
class webpage_crawling():
    ...
    def write_output(self):
        with open('Body_Inverted_Index.dat', 'wb') as f:
            pickle.dump(self.body_inverted_index, f)
        f.close()
        del f
        with open('Body_Forward_Index.dat', 'wb') as f:
            pickle.dump(self.body_forward_index, f)
        f.close()
        del f
        with open('Body_DF_Index.dat', 'wb') as f:
            pickle.dump(self.body_df_index, f)
        f.close()
        del f
        with open('Header_Inverted_Index.dat', 'wb') as f:
            pickle.dump(self.header_inverted_index, f)
        f.close()
        del f
        with open('Header_Forward_Index.dat', 'wb') as f:
            pickle.dump(self.header_forward_index, f)
        f.close()
        del f
        with open('Header_DF_Index.dat', 'wb') as f:
            pickle.dump(self.header_df_index, f)
        f.close()
        del f
        with open('stopword_list.dat', 'wb') as f:
            pickle.dump(self.stopword_list, f)
        f.close()
        del f
        with open('url_list.dat', 'wb') as f:
            pickle.dump(self.url_list, f)
        f.close()
        del f
        with open('header_doc_length.dat', 'wb') as f:
            pickle.dump(self.header_doc_length, f)
        f.close()
        del f
        with open('body_doc_length.dat', 'wb') as f:
            pickle.dump(self.body_doc_length, f)
        f.close()
        del f
        with open('page_rank_index.dat', 'wb') as f:
            pickle.dump(self.page_rank_index, f)
        f.close()
        del f
        with open('body_content.dat', 'wb') as f:
            pickle.dump(self.body_content, f)
        f.close()
        del f
        with open('header_content.dat', 'wb') as f:
    ...
    def webpage_content_fetch(self,urllistpath='',stopwordpath=''):
        ...
        self.header_doc_length = self.doc_length(self.header_forward_index, self.header_inverted_index, self.header_df_index)
...
if __name__ == '__main__':
    ...
    url_path = 'url_list_with_date.txt'
    stopword_path = 'stopwords.txt'
    f = open('url_forward_index.json', 'r')
